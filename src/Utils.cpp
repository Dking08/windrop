...
void PrintUsage(FILE* out)
{
    fwprintf(out,
        ...
        L"Usage:\n"
        L"  windrop <files...>\n"
        L"  windrop --verbose <files...>\n"
        L"  windrop -v | --version\n"
        L"  windrop -h | --help\n\n"
        L"Options:\n"
        L"  --verbose        Show detailed control instructions\n"
        L"  -v, --version    Show version information\n"
        L"  -h, --help       Show this help message\n\n"
        L"Controls:\n"
        L"  - Mouse:    Drag the floating card directly into any window\n"
        L"  - Keyboard: Hover over target window and press [F8] to drag -> press [F8] or left-click to drop\n"
        L"  - Dismiss:  Press [Esc] or right-click on card\n\n"
        L"Examples:\n"
        L"  windrop a.txt\n"
        L"  windrop *.png\n"
